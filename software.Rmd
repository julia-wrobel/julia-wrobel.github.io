...
`R` software for registering exponential family functional data. Available on [GitHub](https://github.com/julia-wrobel/registr); code currently under review at [JOSS](https://joss.theoj.org/).
