...
I developed a method to **register exponential family functional data**, which was recently published in [Biometrics](https://onlinelibrary.wiley.com/journal/15410420); the full text is available [here](https://onlinelibrary.wiley.com/doi/abs/10.1111/biom.12963). Our methods are implemented in the `registr` package, a GitHub hosted `R` package you can download [here](https://github.com/julia-wrobel/registr).
